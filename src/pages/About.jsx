...
// const About = () => {
//   return (
//     <div className="w-full p-8 mx-auto shadow-lg bg-gray-700 rounded-lg">
//       <div className="flex">
...
//       <section className="flex flex-row items-center justify-center  p-6 rounded-lg shadow-md mt-6 w-full">
//         <TeamSection />
//       </section>
