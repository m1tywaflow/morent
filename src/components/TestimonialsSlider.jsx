...
const TestimonialsSlider = () => {
  ...
  return (
    <div className="relative w-full max-h-1200 bg-gray-700 py-10">
      <h2 className="text-3xl font-bold mb-6 text-center text-amber-100">Reviews</h2>
      <div className="relative w-full">
      <AnimatePresence initial={false} custom={direction}>
  <motion.div
    key={selectedItem}
    initial={{ opacity: 0, x: direction === 1 ? 100 : -100, height: "auto" }} 
    animate={{
      opacity: 1,
      x: 0,
      height: "auto",  
  ...
  >
    <div className="text-center bg-gray-700 p-8 rounded-lg shadow-lg">
      ...
      <p className="text-amber-100 text-lg">{testimonials[selectedItem].role}</p>
    </div>
  </motion.div>
</AnimatePresence>
